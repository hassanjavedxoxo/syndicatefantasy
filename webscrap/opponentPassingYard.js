...
const scrapeData = async () => {
    try {
        ...
        const { data } = await axios.get('https://www.teamrankings.com/nfl/stat/opponent-passing-yards-per-game');
        ...
        const filePath = path.resolve(__dirname, '../webscrap/opponentPassingYardJSON.json');
        fs.writeFileSync(filePath, JSON.stringify(tableRows, null, 2), 'utf8');
        console.log('Data saved to opponentPassingYardJSON.json');
