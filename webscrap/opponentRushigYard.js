...
const scrapeData = async () => {
    try {
        ...
        const { data } = await axios.get('https://www.teamrankings.com/nfl/stat/opponent-rushing-yards-per-game');
        ...
        const filePath = path.resolve(__dirname, '../webscrap/opponentRushingYardJSON.json');
        fs.writeFileSync(filePath, JSON.stringify(tableRows, null, 2), 'utf8');
        console.log('Data saved to opponentRushingYardJSON.json');
